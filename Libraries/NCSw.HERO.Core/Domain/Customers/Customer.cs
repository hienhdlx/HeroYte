...
namespace NCSw.HERO.Core.Domain.Customers
{
    /// <summary>
    ...
    public partial class Customer : BaseEntity
    {
        ...
        private ICollection<Hospital> _listOfHospitalCreatedBy;
        private ICollection<Hospital> _listOfHospitalUpdatedBy;
        private ICollection<Service> _listOfServiceCreatedBy;
        private ICollection<Service> _listOfServiceUpdatedBy;
        private ICollection<Department> _listOfDepartmentCreatedBy;
        private ICollection<Department> _listOfDepartmentUpdatedBy;
        private ICollection<Appointment> _listOfAppointmentCreatedBy;
        private ICollection<Appointment> _listOfAppointmentUpdatedBy;
        public Customer()
        {
        ...
        public virtual ICollection<Hospital> ListOfHospitalCreatedBy
        {
            get => _listOfHospitalCreatedBy ?? (_listOfHospitalCreatedBy = new List<Hospital>());
            protected set => _listOfHospitalCreatedBy = value;
        }
        public virtual ICollection<Hospital> ListOfHospitalUpdatedBy
        {
            get => _listOfHospitalUpdatedBy ?? (_listOfHospitalUpdatedBy = new List<Hospital>());
            protected set => _listOfHospitalUpdatedBy = value;
        }

        public virtual ICollection<Service> ListOfServiceCreatedBy
        {
            get => _listOfServiceCreatedBy ?? (_listOfServiceCreatedBy = new List<Service>());
            protected set => _listOfServiceCreatedBy = value;
        }
        public virtual ICollection<Service> ListOfServiceUpdatedBy
        {
            get => _listOfServiceUpdatedBy ?? (_listOfServiceUpdatedBy = new List<Service>());
            protected set => _listOfServiceUpdatedBy = value;
        }

        public virtual ICollection<Department> ListOfDepartmentCreatedBy
        {
            get => _listOfDepartmentCreatedBy ?? (_listOfDepartmentCreatedBy = new List<Department>());
            protected set => _listOfDepartmentCreatedBy = value;
        }
        public virtual ICollection<Department> ListOfDepartmentUpdatedBy
        {
            get => _listOfDepartmentUpdatedBy ?? (_listOfDepartmentUpdatedBy = new List<Department>());
            protected set => _listOfDepartmentUpdatedBy = value;
        }

        public virtual ICollection<Appointment> ListOfAppointmentCreatedBy
        {
            get => _listOfAppointmentCreatedBy ?? (_listOfAppointmentCreatedBy = new List<Appointment>());
            protected set => _listOfAppointmentCreatedBy = value;
        }
        public virtual ICollection<Appointment> ListOfAppointmentUpdatedBy
        {
            get => _listOfAppointmentUpdatedBy ?? (_listOfAppointmentUpdatedBy = new List<Appointment>());
            protected set => _listOfAppointmentUpdatedBy = value;
        }
