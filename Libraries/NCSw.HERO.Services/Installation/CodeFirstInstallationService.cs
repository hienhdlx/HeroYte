...
namespace NCSw.HERO.Services.Installation
{
    /// <summary>
        ...
        protected virtual void InstallScheduleTasks()
        {
            var tasks = new List<ScheduleTask>
            {
                new ScheduleTask
                {
                    Name = "Send emails",
                    Seconds = 60,
                    Type = "NCSw.HERO.Services.Messages.QueuedMessagesSendTask, NCSw.HERO.Services",
                    Enabled = true,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    Name = "Keep alive",
                    Seconds = 300,
                    Type = "NCSw.HERO.Services.Common.KeepAliveTask, NCSw.HERO.Services",
                    Enabled = true,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    Name = "Delete guests",
                    Seconds = 600,
                    Type = "NCSw.HERO.Services.Customers.DeleteGuestsTask, NCSw.HERO.Services",
                    Enabled = true,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    Name = "Clear cache",
                    Seconds = 600,
                    Type = "NCSw.HERO.Services.Caching.ClearCacheTask, NCSw.HERO.Services",
                    Enabled = false,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    ...
                    //60 minutes
                    Seconds = 3600,
                    Type = "NCSw.HERO.Services.Logging.ClearLogTask, NCSw.HERO.Services",
                    Enabled = false,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    ...
                    //60 minutes
                    Seconds = 3600,
                    Type = "NCSw.HERO.Services.Directory.UpdateExchangeRateTask, NCSw.HERO.Services",
                    Enabled = true,
                    StopOnError = false
                }
            };
