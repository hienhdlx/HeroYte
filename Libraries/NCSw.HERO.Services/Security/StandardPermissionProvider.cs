...
namespace NCSw.HERO.Services.Security
{
    /// <summary>
    ...
    public partial class StandardPermissionProvider : IPermissionProvider
    {
        ...
        // HERO
        public static readonly PermissionRecord ManageServices = new PermissionRecord { Name = "Admin area. Manage Services", SystemName = "ManageServices", Category = "Directory" };
        public static readonly PermissionRecord ManageDoctors = new PermissionRecord { Name = "Admin area. Manage Doctors", SystemName = "ManageDoctors", Category = "Directory" };
        public static readonly PermissionRecord ManageShifts = new PermissionRecord { Name = "Admin area. Manage Shifts", SystemName = "ManageShifts", Category = "Directory" };
