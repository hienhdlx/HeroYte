...
namespace NCSw.HERO.Web.Framework.Extensions
{
    /// <summary>
    /// HTML extensions
    /// </summary>
    public static class HtmlExtensions
    {
            ...
            string optionLabel = null) where TEnum : struct
        {
            ...
            var metadataProvider = ExpressionMetadataProvider.FromLambdaExpression(expression, htmlHelper.ViewData, htmlHelper.MetadataProvider);
            ModelMetadata metadata = metadataProvider.Metadata;
            ...
            IEnumerable<SelectListItem> items =
                values.Select(value => new SelectListItem
                {
                    ...
                    Selected = value.Equals(metadataProvider.Model.Convert(enumType))
                });
