...
using NCSw.HERO.Core.Infrastructure.DependencyManagement;
using NCSw.HERO.Core.Plugins;
using NCSw.HERO.Data;
using NCSw.HERO.Services;
using NCSw.HERO.Services.Affiliates;
using NCSw.HERO.Services.Authentication;
...
using NCSw.HERO.Services.Themes;
using NCSw.HERO.Services.Topics;
using NCSw.HERO.Services.Vendors;
using NCSw.HERO.Web.Framework.Mvc.Routing;
using NCSw.HERO.Web.Framework.Themes;
using NCSw.HERO.Web.Framework.UI;

namespace NCSw.HERO.Web.Framework.Infrastructure
{
    /// <summary>
