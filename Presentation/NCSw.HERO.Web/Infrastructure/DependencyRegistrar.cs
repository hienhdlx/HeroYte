...
namespace NCSw.HERO.Web.Infrastructure
{
    /// <summary>
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            // HERO 
            builder.RegisterType<ServiceModelFactory>().As<IServiceModelFactory>().InstancePerLifetimeScope();
            builder.RegisterType<DepartmentModelFactory>().As<IDepartmentModelFactory>().InstancePerLifetimeScope();
            builder.RegisterType<AppointmentModelFactory>().As<IAppointmentModelFactory>().InstancePerLifetimeScope();
            builder.RegisterType<DoctorModelFactory>().As<IDoctorModelFactory>().InstancePerLifetimeScope();
            builder.RegisterType<ShiftModelFactory>().As<IShiftModelFactory>().InstancePerLifetimeScope();
