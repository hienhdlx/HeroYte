...
namespace NCSw.HERO.Web.Areas.Admin.Factories
{
    ...
    public partial interface IBaseAdminModelFactory
    {
        ...
        void PrepareDepartmentTemplates(IList<SelectListItem> items, bool withSpecialDefaultItem = true, string defaultItemText = null);
        /// <summary>
        ...
        /// <param name="withSpecialDefaultItem"></param>
        /// <param name="defaultItemText"></param>
        void PrepareServiceTemplates(IList<SelectListItem> items, bool withSpecialDefaultItem = true, string defaultItemText = null);
        /// <summary>
        ...
        /// <param name="withSpecialDefaultItem"></param>
        /// <param name="defaultItemText"></param>
        void PrepareDoctorTemplates(IList<SelectListItem> items, bool withSpecialDefaultItem = true, string defaultItemText = null);
    }
}