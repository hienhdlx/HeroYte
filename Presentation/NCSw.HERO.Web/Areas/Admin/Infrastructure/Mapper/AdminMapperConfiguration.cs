...
using NCSw.HERO.Core.Domain.Affiliates;
...
using NCSw.HERO.Core.Domain.Polls;
...
using NCSw.HERO.Core.Domain.Tasks;
...
using NCSw.HERO.Core.Infrastructure.Mapper;
...
using NCSw.HERO.Web.Areas.Admin.Models.Affiliates;
using NCSw.HERO.Web.Areas.Admin.Models.Blogs;
...
using NCSw.HERO.Web.Areas.Admin.Models.ExternalAuthentication;
using NCSw.HERO.Web.Areas.Admin.Models.Forums;
using NCSw.HERO.Web.Areas.Admin.Models.Localization;
using NCSw.HERO.Web.Areas.Admin.Models.Logging;
...
using NCSw.HERO.Web.Areas.Admin.Models.Payments;
...
namespace NCSw.HERO.Web.Areas.Admin.Infrastructure.Mapper
{
    /// <summary>
    ...
    public class AdminMapperConfiguration : Profile, IOrderedMapperProfile
    {
        ...
        protected virtual void CreateHeroMaps()
        {
            CreateMap<Service, ServiceModel>()
                .ForMember(x => x.CreatedByUser, options => options.Ignore())
                .ForMember(x => x.CustomProperties, options => options.Ignore())
                .ForMember(x => x.Form, options => options.Ignore())
                .ForMember(x => x.Hospital, options => options.Ignore())
                .ForMember(x => x.Locales, options => options.Ignore())
                .ForMember(x => x.UpdatedByUser, options => options.Ignore());
            CreateMap<ServiceModel, Service>()
                .ForMember(x => x.CreatedBy, options => options.Ignore())
                .ForMember(x => x.CreatedByUser, options => options.Ignore())
                .ForMember(x => x.CreatedOnUtc, options => options.Ignore())
                .ForMember(x => x.Hospital, options => options.Ignore())
                .ForMember(x => x.HospitalId, options => options.Ignore())
                .ForMember(x => x.UpdatedOnUtc, options => options.Ignore())
                .ForMember(x => x.UpdatedByUser, options => options.Ignore());
            ...
            CreateMap<Department, DepartmentModel>()
                ...
                .ForMember(x => x.Hospital, options => options.Ignore())
                .ForMember(x => x.Locales, options => options.Ignore())
                .ForMember(x => x.DepartmentListTemplates, options => options.Ignore())
                .ForMember(x => x.UpdatedByUser, options => options.Ignore());
            ...
            CreateMap<Appointment, AppointmentModel>()
                ...
                .ForMember(x => x.UpdatedByUser, options => options.Ignore())
                .ForMember(x => x.DepartmentListTemplates, options => options.Ignore())
                .ForMember(x => x.ServiceListTemplates, options => options.Ignore())
                .ForMember(x => x.DoctorListTemplates, options => options.Ignore());
